...
describe("Calculator", () => {
  ...
  describe("TestSubtractExpression()", () => {
    ...
    it("should return 1 when the expression is 1 - 0", () => {
      assert.equal(claculator.parseExpr("1-0"), 1);
    });
  });
});
